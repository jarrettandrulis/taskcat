...
from takcat._cli_core import longform_param_required
...
class Upload:
    ...
    @longform_param_required('dry_run')
    def __init__(
        self,
        ...
        :param key_prefix: provide a custom key-prefix for uploading to S3. This will be used instead of `project` => `name` in the config
